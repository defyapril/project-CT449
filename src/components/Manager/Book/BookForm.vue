...
<template>
    <div class="nxb">
        <div class="d-flex flex-column">
            ...
            <el-input v-model="book.tensach" style="width: 300px" size="large" placeholder="Enter name book" />
        </div>
        ...
        <div class="d-flex flex-column my-2">
            <label>Number:</label>
            <el-input v-model="book.soquyen" style="width: 300px" size="large" placeholder="Enter amount of books" />
        </div>
        ...
        <div class="d-flex flex-column my-2">
            ...
            <el-input
                ...
                style="width: 300px"
                size="large"
                placeholder="Enter Year of publisher"
            />
        </div>
        <div class="d-flex flex-column my-2">
            <label>Author:</label>
            <el-input v-model="book.tacgia" style="width: 300px" size="large" placeholder="Enter author" />
        </div>
        <!-- <div class="d-flex flex-column my-2" style="width: 300px">
